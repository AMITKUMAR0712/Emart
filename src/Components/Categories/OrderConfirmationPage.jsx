...
const OrderConfirmationPage = () => {
  ...
  return (
    <ConfirmationContainer>
      ...
      <Button onClick={() => navigate("/invoice")}>Download</Button>
    </ConfirmationContainer>
  );
};
...
//   const usedSuperCoins = JSON.parse(sessionStorage.getItem("usedSuperCoins")) || 0;
...
//   useEffect(() => {
//     setRemainingSuperCoins(user.supercoin);
...
//           const newSuperCoinBalance = user.supercoin + earnedCoins;
...
//           {/* <p className="text-success">Updated SuperCoins: <strong>{remainingSuperCoins}</strong></p> */}
...
// //             await fetch(`http://localhost:8282/api/cart/remove/${cartId}`, {
// //               method: "DELETE",
// //             });
// //           })
// //         );
// //         console.log("✅ Products removed from cart & database.");
// //       }
