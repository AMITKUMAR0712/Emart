...
//               <h4 className="text-success">Price: ₹{product.price.toLocaleString()}</h4>
//               {/* <h5 className="text-danger fw-bold">
//                 Discounted Price: ₹{(product.price - product.discount).toLocaleString()}
//               </h5> */}
...
//   const supercoinBalance = user ? user.supercoin : 0;
//   console.log(supercoinBalance);
//   useEffect(() => {
//     const fetchProductDetails = async () => {
//       try {
//         const response = await fetch(`http://localhost:8282/api/products/${productId}`);
...
//         // priceOptions.push({ label: "Loyalty Price + SuperCoins", amount: (price + "+" +  newsupercoin) });
...
//                     <div>
//                       {/* Remove radio button for "Original Price" */}
...
//               {/* Show Savings if a price option is selected */}
